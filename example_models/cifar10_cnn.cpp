...
void get_cifar10_cnn_ctx(Context &ctx, Tensor *input_0)
{
    ...
    {
        ctx.add(new RamTensor<uint8_t>(), "max_pool_lVRkqj6v/eightbit:0", 1);
        ctx.add(new RamTensor<float>({1}), "max_pool_lVRkqj6v/eightbit:1", 1);
        ctx.add(new RamTensor<float>({1}), "max_pool_lVRkqj6v/eightbit:2", 1);

        ctx.push(new QuantizedMaxPoolingOp<uint8_t>(2, 2, 2, 2, VALID),
                 {"conv_1/logits/eightbit/requantize:0", "conv_1/logits/eightbit/requantize:1", "conv_1/logits/eightbit/requantize:2"},
                 {"max_pool_lVRkqj6v/eightbit:0", "max_pool_lVRkqj6v/eightbit:1", "max_pool_lVRkqj6v/eightbit:2"});

        ctx.eval();
    }
    {
        ctx.add(new RamTensor<uint8_t>(), "relu_lVRkqj6v/eightbit:0", 1);
        ctx.add(new RamTensor<float>({1}), "relu_lVRkqj6v/eightbit:1", 1);
        ctx.add(new RamTensor<float>({1}), "relu_lVRkqj6v/eightbit:2", 1);
        ctx.push(new QuantizedReluOp<uint8_t, float, uint8_t>(),
                 {"max_pool_lVRkqj6v/eightbit:0", "max_pool_lVRkqj6v/eightbit:1", "max_pool_lVRkqj6v/eightbit:2"},
                 {"relu_lVRkqj6v/eightbit:0", "relu_lVRkqj6v/eightbit:1", "relu_lVRkqj6v/eightbit:2"});
        ctx.eval();
    }
    {
    ...
    }
    {
        ...
        ctx.push(new QntConvOp<uint8_t, uint8_t, int>({1, 2, 2, 1}, VALID),
                 {"relu_lVRkqj6v/eightbit:0", "conv_2/Variable_quantized_const:0", "relu_lVRkqj6v/eightbit:1", "relu_lVRkqj6v/eightbit:2", "conv_2/Variable_quantized_min:0", "conv_2/Variable_quantized_max:0"},
    ...
    {
        ctx.add(new RamTensor<uint8_t>(), "max_pool_un4odc9L/eightbit:0", 1);
        ctx.add(new RamTensor<float>({1}), "max_pool_un4odc9L/eightbit:1", 1);
        ctx.add(new RamTensor<float>({1}), "max_pool_un4odc9L/eightbit:2", 1);

        ctx.push(new QuantizedMaxPoolingOp<uint8_t>(2, 2, 2, 2, VALID),
                 {"conv_3/logits/eightbit/requantize:0", "conv_3/logits/eightbit/requantize:1", "conv_3/logits/eightbit/requantize:2"},
                 {"max_pool_un4odc9L/eightbit:0", "max_pool_un4odc9L/eightbit:1", "max_pool_un4odc9L/eightbit:2"});

        ctx.eval();
    }
    {
        ctx.add(new RamTensor<uint8_t>(), "relu_un4odc9L/eightbit:0", 1);
        ctx.add(new RamTensor<float>({1}), "relu_un4odc9L/eightbit:1", 1);
        ctx.add(new RamTensor<float>({1}), "relu_un4odc9L/eightbit:2", 1);
        ctx.push(new QuantizedReluOp<uint8_t, float, uint8_t>(),
                 {"max_pool_un4odc9L/eightbit:0", "max_pool_un4odc9L/eightbit:1", "max_pool_un4odc9L/eightbit:2"},
                 {"relu_un4odc9L/eightbit:0", "relu_un4odc9L/eightbit:1", "relu_un4odc9L/eightbit:2"});
        ctx.eval();
    }
    {
    ...
    }
    {
        ...
        ctx.push(new QntConvOp<uint8_t, uint8_t, int>({1, 1, 1, 1}, VALID),
                 {"relu_un4odc9L/eightbit:0", "conv_4/Variable_quantized_const:0", "relu_un4odc9L/eightbit:1", "relu_un4odc9L/eightbit:2", "conv_4/Variable_quantized_min:0", "conv_4/Variable_quantized_max:0"},
